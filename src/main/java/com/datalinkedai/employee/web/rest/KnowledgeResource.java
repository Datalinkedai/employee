...
/**
 * REST controller for managing {@link com.datalinkedai.employee.domain.Knowledge}.
 */
@RestController
@RequestMapping("/api")
public class KnowledgeResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new knowledge, or with status {@code 400 (Bad Request)} if the knowledge has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/knowledges")
    public Mono<ResponseEntity<Knowledge>> createKnowledge(@Valid @RequestBody Knowledge knowledge) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated knowledge,
     * or with status {@code 400 (Bad Request)} if the knowledge is not valid,
     * or with status {@code 500 (Internal Server Error)} if the knowledge couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /knowledges/:id} : Partial updates given fields of an existing knowledge, field will ignore if it is null
     *
     * @param id the id of the knowledge to save.
     * @param knowledge the knowledge to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated knowledge,
    ...
    public Mono<ResponseEntity<Knowledge>> partialUpdateKnowledge(
        @PathVariable(value = "id", required = false) final String id,
        @NotNull @RequestBody Knowledge knowledge
    ) throws URISyntaxException {
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of knowledges in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the knowledge, or with status {@code 404 (Not Found)}.
     */
